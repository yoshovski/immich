 ...
 * Get time bucket
 */
export function getTimeBucket({ albumId, bbox, hasCoordinates, isFavorite, isTrashed, key, order, personId, slug, tagId, timeBucket, userId, visibility, withCoordinates, withPartners, withStacked }: {
    albumId?: string;
    bbox?: string;
 ...
 * Get time buckets
 */
export function getTimeBuckets({ albumId, bbox, hasCoordinates, isFavorite, isTrashed, key, order, personId, slug, tagId, userId, visibility, withCoordinates, withPartners, withStacked }: {
    albumId?: string;
    bbox?: string;
    hasCoordinates?: boolean;
    isFavorite?: boolean;
